...
module.exports = async (req, res) => {
    ...
    const username = req.query.username || 'dp';
    ...
    try {
        ...
        if (!r.ok) return res.status(r.status).send('Failed to download image');
        ...
        res.setHeader('Content-Disposition', `attachment; filename="${username}_dp_hd.${ext}"`);
